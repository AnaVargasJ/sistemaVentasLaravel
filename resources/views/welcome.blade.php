...
<header class="header" id="header">
    ...
    <nav class="nav-container">
        ...
        <div class="nav__menu" id="nav-menu">
            <ul class="nav__list">
                ...
                <li class="nav__item">
                    <a href="{{ route('productos.index') }}" class="nav__link active-link">Nosotros</a>
                </li>
                <li class="nav__item">
                    <a href="{{ route('productos.index') }}" class="nav__link active-link"></a>
                </li>
            </ul>
        </div>
    </nav>
 ...
 <br><br><br><br><br><br>
<div class="content" id="bienvenida">
   <b><h1>Bienvenido</h1></b>
</div>
<div class="div">
    <p class="button">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsa, dignissimos eligendi enim reprehenderit consequatur eaque praesentium aspernatur consectetur ipsum pariatur deleniti error blanditiis minima? Dicta ratione animi culpa quae dolorem.</p>
</div>
<div class="button">
   <a  href="{{ route('login') }}"> <button type="submit" class="btn btn-outline-dark btn-lg" id="botones" >Comenzar</button></a>
</div>
